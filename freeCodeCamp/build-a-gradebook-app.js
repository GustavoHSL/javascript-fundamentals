...
function studentMsg(scores, studentScore){
  ...
  return `Class average: ` + getAverage(scores) + `. Your grade: ` + getGrade(studentScore) + `. You ` + (hasPassingGrade(studentScore) ? "passed" : "failed") + ` the course.` ;

}

//console.log(studentMsg([50,60,70], 50));